...
public class Item{
    ...
    public boolean use(Game game){
        ...
        if(name.equals("light switch")){
            ...
            System.out.println(game.getCurrentRoom().getDescription(game));
            return false;
        }
        if(name.equals("sink")){
        ...
        if(name.equals("cup of coffe")){
            System.out.println("You taste the coffe, it tastes good.");
            return false;
        }
        ...
        //Här är en teleporter som teleporterar dig till ett slumpmässigt rum:
        if(name.equals("blue pill")){
            System.out.println("You feel a little dizzy and within seconds you are unconcious.\nYou slowly wake up again...");
            Random r = new Random();
            game.teleport(new Point(r.nextInt(2000) - 1000, r.nextInt(2000) - 1000));
            return true;
        }
