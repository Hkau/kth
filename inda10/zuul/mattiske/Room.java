...
public class Room 
{
     ...
     */
    public String getDescription(int tittriktning)
    {
        return !dark? generateDescription(tittriktning) : "It's too dark to see anything";
    }
    /**
     ...
     */
    private String generateDescription(int tittriktning){
        ...
        for(int i = 0; i < 4; i++){
            ...
            //Se gameklassen för förklaring av min turnary operator.
            switch((((5 - tittriktning) % 4) + i) % 4){
    ...
    public void searchRoom(Game game){
        ...
        for(int i = 0; i < 4; i++){
            if(doors[i] == null) continue;
            switch((((5 - game.getTittriktning()) % 4) + i) % 4){
     ...
     */
    public void setDark(boolean newValue, int tittriktning){
        dark = newValue;
        System.out.println(getDescription(tittriktning));
    }
}
