...
public interface UndirectedGraph {
     ...
     * @throws IllegalArgumentException if v is out of range
     */
    public VertexIterator adjacentVertices(int v) throws IllegalArgumentException;
     ...
     */
    public boolean areAdjacent(int v, int w) throws IllegalArgumentException;
     ...
     */
    public void addEdge(int v, int w, int c) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException if v or w are out of range
     */
    public void removeEdge(int v, int w) throws IllegalArgumentException;
}
